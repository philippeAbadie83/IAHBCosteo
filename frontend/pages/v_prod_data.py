...
def v_prod_data_page():
    def content():
        ...
        # 3. Definir columnas
        columnas = [
            {"name": "familia", "label": "Familia", "field": "familia", "align": "left", "sortable": True},
            {"name": "proveedor", "label": "Proveedor", "field": "proveedor", "align": "left", "sortable": True},
            {"name": "sku_prov", "label": "SKU Proveedor", "field": "sku_prov", "align": "center", "sortable": True},
            {"name": "sku_sys", "label": "SKU Sistema", "field": "sku_sys", "align": "center", "sortable": True},
            {"name": "nombre", "label": "Nombre Producto", "field": "nombre", "align": "left", "sortable": True},
            {"name": "version", "label": "Versión", "field": "version", "align": "center", "sortable": True},
            {"name": "fecha_update", "label": "Última Actualización", "field": "fecha_update", "align": "center", "sortable": True},
        ]
